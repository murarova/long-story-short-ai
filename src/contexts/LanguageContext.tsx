...
const translations: Record<Language, Record<string, string>> = {
  uk: {
    "app.title": "Транскрибуй та Розумій",
    "app.subtitle": "Завантажте відео або аудіо, та задавайте питання про вміст за допомогою ШІ.",
    ...
    "upload.supportedFormats": "Підтримувані формати: MP4, MKV, MOV, WebM, MP3, WAV, M4A",
    ...
    "toast.downloadingTranscriptDesc": "Ваш повний транскрипт буде готовий незабаром.",
    "toast.generatingSummary": "Генерування резюме",
    "toast.generatingSummaryDesc": "Ваше резюме буде готове незабаром.",
  },
  en: {
    "app.title": "Transcribe & Understand",
    "app.subtitle": "Upload any video or audio, and ask questions about the content using AI.",
    ...
    "upload.supportedFormats": "Supported formats: MP4, MKV, MOV, WebM, MP3, WAV, M4A",
    ...
    "toast.downloadingTranscriptDesc": "Your full transcript will be ready shortly.",
